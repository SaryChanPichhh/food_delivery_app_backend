...
import com.example.food_delivery_app.backend_admin.interfaces.ISaleService;
...
@Service
@AllArgsConstructor
public class AdminSaleService implements ISaleService {
    ...
    public List<RestaurantResponseDto> getRestaurantInfo(int userId) {
        ...
        return new ArrayList<RestaurantResponseDto>() {
        };
    }
