...
public class DashBoradController {
    ...
    public Map<String, Object> index(
        ...
        response.put("totalUser", totalUsers);
        response.put("totalStaff", totalStaff);
        response.put("totalRes", totalRes);
        response.put("totalSaleToday", totalSaleInRange);
        response.put("totalCommissionToday", totalCommissionInRange);
        response.put("totalOrders", totalOrdersInRange);
        
        response.put("topUsers", topUsers);
        response.put("topRestaurants", topRestaurants);
        response.put("todayOrders", filteredOrders);
        response.put("topMenus", topMenus);
